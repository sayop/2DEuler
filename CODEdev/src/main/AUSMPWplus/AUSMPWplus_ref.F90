...
!        XEPr(3) = Pr * XIY
        ...
        write(*,*) FPhalf(1,i,j),FPhalf(2,i,j),FPhalf(3,i,j),FPhalf(4,i,j)
        DO n = 1, 4
...
!        XEPr(2) = Pr * ETAX
!        XEPr(3) = Pr * ETAY
        GPhalf(1,i,j) = MbarLplus * Cavg * A1 * UL(1) + &
                        MbarRminus * Cavg * A1 * UR(1)
        GPhalf(2,i,j) = MbarLplus * Cavg * A1 * UL(2) + &
                        MbarRminus * Cavg * A1 * UR(2) + &
                        Ps * ETAX
        GPhalf(3,i,j) = MbarLplus * Cavg * A1 * UL(3) + &
                        MbarRminus * Cavg * A1 * UR(3) + &
                        Ps * ETAY
        GPhalf(4,i,j) = MbarLplus * Cavg * A1 * (UL(4) + Pl) + &
                        MbarRminus * Cavg * A1 * (UR(4) + Pr)
        DO n = 1, 4
